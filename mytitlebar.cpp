...
void MyTitleBar::initControl()
{
    ...
    m_pButtonMax->setStyleSheet(tr("border-image: url(:/icon/max.png);"));
    m_pButtonMin->setStyleSheet(tr("border-image: url(:/icon/min.png);"));
    m_pButtonClose->setStyleSheet(tr("border-image: url(:/icon/close.png);"));
