...
// 纯色按钮
void Chat::on_colorToolButton1_clicked()
{
    color = QColorDialog::getColor(color,this);
    if(color.isValid()) {
    ui->textBrowser->setStyleSheet("QTextBrowser{background-color: rgba(255, 255, 255, 0.7);}");
    ui->messageTextEdit->setStyleSheet("QTextEdit{background-color: rgba(255, 255, 255, 0.7);}");
    setPalette(QPalette(color));
}
}
// 换肤按钮
void Chat::on_skinToolButton_clicked(){
...
//展示语音输入窗口
void Chat::on_speakToolButton_clicked()
{
